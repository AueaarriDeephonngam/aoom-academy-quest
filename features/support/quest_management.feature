Feature: Quest Management
  ...
  Scenario: Mark quest as completed
    Given I have a completed quest titled "Complete daily exercise"
    When I visit the quest page
    Then the quest "Complete daily exercise" should be marked as completed

  Scenario: Delete a quest
    Given I have a quest titled "Old task to remove"
    When I visit the quest page
    And I click the delete button for "Old task to remove"
    Then I should not see the quest "Old task to remove"
